...
function Navbar() {
  ...
  const navItems =
    location.pathname.startsWith("/patienthomeui")
      ? [
          { id: 1, text: "Profile", route: "/patienthomeui-profile" },
          { id: 2, text: "Record", route: "/patienthomeui-record" },
          { id: 3, text: "Setting", route: "/patienthomeui-setting" },
          { id: 4, text: "Help", route: "/patienthomeui-help" },
        ]
      : [
